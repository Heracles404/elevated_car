...
public class FloorLevel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floor_level3);

        Button move = findViewById(R.id.button_Floor3Down);
        move.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FloorLevel3.this, ElevatorLevel3.class);
                ...
                new FloorLevel3.UpdateDestinationTask().execute(androidID, "0"); // Replace "1" with the actual origin value you want to set

                // Update the origin in the PHP database
                new UpdateOriginTask().execute(androidID, "3"); // Replace "1" with the actual origin value you want to set
            }
        });
